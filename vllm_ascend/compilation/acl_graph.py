...
def update_full_graph_params(
    ...
    # GLM52_MTP_GRAPH_FIX_001: sample_tokens is a standalone worker RPC and
    # does not carry the current-vLLM-config context used by SFA backend
    # selection. Scope the explicit config to backend resolution only.
